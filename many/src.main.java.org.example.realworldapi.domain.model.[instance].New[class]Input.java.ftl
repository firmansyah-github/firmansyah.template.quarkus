...
${PRV_SYS_GEN_FILENAME|New[class]Input.java|Private System placeholder for define file name that need to be generated, if required to be different with template name}
...
@Data
@AllArgsConstructor
public class New${entity.className}Input {
